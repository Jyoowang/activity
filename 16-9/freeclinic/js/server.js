...
$(function() {
    ...
    $('.more-case').click(function(){
    	isApp(function(){
		     yuer24hGoto({type:15,typeName:0})
    	},function(){
    		window.location="http://www.yuer24h.com/wechat2/simple/?uid=" + uid + "&did=0#solution"
    	})
    })
	...
	$('.news-list a').click(function(){
		...
		var _this=$(this);
    	isApp(
    		function(){yuer24hGoto({type:2,typeName:newid})},
    		function(){window.location= 'http://www.yuer24h.com/HelperPage/User/ArticleShare/newsshow.html?ArticleID='+ newid +'&UserID='+ uid +'&businesschannel=1'}
    		)
